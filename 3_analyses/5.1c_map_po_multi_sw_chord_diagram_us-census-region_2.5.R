...
# read in data ------------------------------------------------------------
po8_sw_multi_sw_state_cat_scatter <- read_csv(paste0(path_data_processed, "multi_po_sw_2.5.csv"))
...
# Midwest region
pdf(file = "/Users/vivian/Desktop/0_PhD/0_Research Projects/power_outage-severe_weather-coocurrence/analysis/output/figures/multi_sw_chord_diag_cbfriendly_midwest_2.5.pdf",
    width = 10,
    height = 7)
...
# Northeast region
pdf(file = "/Users/vivian/Desktop/0_PhD/0_Research Projects/power_outage-severe_weather-coocurrence/analysis/output/figures/multi_sw_chord_diag_cbfriendly_northeast_2.5.pdf",
    width = 10,
    height = 7)
...
# South region
pdf(file = "/Users/vivian/Desktop/0_PhD/0_Research Projects/power_outage-severe_weather-coocurrence/analysis/output/figures/multi_sw_chord_diag_cbfriendly_south_2.5.pdf",
    width = 10,
    height = 7)
chordDiagram(sw_df3_list$south, transparency = 0.5, grid.col = values)
title("South")
dev.off()

# West region
pdf(file = "/Users/vivian/Desktop/0_PhD/0_Research Projects/power_outage-severe_weather-coocurrence/analysis/output/figures/multi_sw_chord_diag_cbfriendly_west_2.5.pdf",
    width = 10,
    height = 7)
