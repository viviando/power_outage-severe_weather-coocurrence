...
# read in data ------------------------------------------------------------
po8_sw_state_year <- read_csv(paste0(path_data_processed, "po8_sw_state_year_0.1.csv"))
...
write_csv(po8_sw_state_year_prop %>% select(-days, -tot_days), paste0(path_public_data, "po8_sw_state_year_prop.fst"))
...
# map
map_po_ind_sw_state_year_0.1 <- ggplot(po8_sw_state_year_prop, aes(x = year, y = prop_days, fill = sw_type)) +
...
# save --------------------------------------------------------------------
ggsave(paste0(path_map, "fig2_map_po8_sw_state_year_0.1.tiff"), map_po_ind_sw_state_year_0.1, width = 15, height = 10, dpi = 300)
