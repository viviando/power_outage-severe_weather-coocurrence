...
# read in data ------------------------------------------------------------
po8_sw_county <- read_csv(paste0(path_data_processed, "cty_days_sw_po_labeled_2.5.csv")) %>% 
...
# save --------------------------------------------------------------------
ggsave(paste0(path_map, "maps_cty_days_sw_po_labeled_2.5.png"), width = 12, height = 8, dpi = 300)
