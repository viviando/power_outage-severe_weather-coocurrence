...
# read in data ------------------------------------------------------------
po8_sw_state_year <- read_csv(paste0(path_data_processed, "po8_sw_state_year_2.5.csv"))
...
# save --------------------------------------------------------------------
ggsave(paste0(path_map, "map_po8_sw_state_year_2.5.tiff"), width = 15, height = 10, dpi = 300)
