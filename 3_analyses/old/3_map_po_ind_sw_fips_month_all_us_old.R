...
path_map <- "/Users/vivian/Desktop/0_PhD/0_Research Projects/power_outage-severe_weather-coocurrence/analysis/output/"

# read in data ------------------------------------------------------------
po8_sw_state_year <- read_csv(paste0(path_data_processed, "cty_tot_po_sw_0.1.csv"))
...
ggsave(paste0(path_map, "bubble_cty_tot_po_sw_0.1.png"), width = 15, height = 10, dpi = 300)
