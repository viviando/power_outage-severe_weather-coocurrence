...
# read in data ------------------------------------------------------------
po8_county_monthly <- read_csv(paste0(path_data_processed, "cty_tot_po_sw_4.0.csv"))
...
ggsave(paste0(path_map, "sfig3_bubble_cty_tot_po_sw_census_region_4.0.tiff"), width = 15, height = 10, dpi = 300)
