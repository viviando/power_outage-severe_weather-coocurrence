...
# read in data ------------------------------------------------------------
po8_county_monthly <- read_csv(paste0(path_data_processed, "cty_tot_po_sw_0.1.csv"))
...
write_fst(po8_county_monthly, paste0(path_public_data, "po8_county_monthly.fst"))
...
ggsave(paste0(path_map, "fig3_bubble_cty_tot_po_sw_census_region_0.1.tiff"), width = 15, height = 10, dpi = 300)
