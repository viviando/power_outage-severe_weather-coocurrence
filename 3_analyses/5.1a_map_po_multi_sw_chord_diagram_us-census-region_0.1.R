...
write_fst(sw_raw, paste0(path_public_data, "sw_raw.fst"))
...
sectors <- c("Anomalous Cold", "Snowfall", "Anomalous Heat", "Wildfire", "Anomalous Precipitation", "Tropical Cyclone")
...
# Midwest region
pdf(file = "/Users/vivian/Desktop/0_PhD/0_lead_research-projects/power_outage-severe_weather-coocurrence/analysis/output/figures/multi_sw_chord_diag_cbfriendly_midwest_0.1.pdf",
    width = 10,
    height = 7)
...
# Northeast region
pdf(file = "/Users/vivian/Desktop/0_PhD/0_lead_research-projects/power_outage-severe_weather-coocurrence/analysis/output/figures/multi_sw_chord_diag_cbfriendly_northeast_0.1.pdf",
    width = 10,
    height = 7)
...
# South region
# reorder southern sw types because names overlapped
pdf(file = "/Users/vivian/Desktop/0_PhD/0_lead_research-projects/power_outage-severe_weather-coocurrence/analysis/output/figures/multi_sw_chord_diag_cbfriendly_south_0.1.pdf",
    width = 10,
    height = 7)
chordDiagram(
  sw_df3_list$south,
...
# West region
pdf(file = "/Users/vivian/Desktop/0_PhD/0_lead_research-projects/power_outage-severe_weather-coocurrence/analysis/output/figures/multi_sw_chord_diag_cbfriendly_west_0.1.pdf",
    width = 10,
    height = 7)
